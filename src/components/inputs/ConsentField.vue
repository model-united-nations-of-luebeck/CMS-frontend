...
<template>
  <div>
    ...
    <v-checkbox
      ...
      :label="`Media Consent (given on ${new Date(
    ...
    <v-card>
      ...
      <v-card-text>
        <p>
          ...
          registration purposes. Here is our declaration of data usage which
          describes the processing of data and your rights and our
