...
export const usePlenariesStore = defineStore("plenaries", () => {
  ...
  async function getPlenary(plenary_id) {
    //notice the singular form of the function name
    loading.value = true;
    await http
      .get(`plenaries/${plenary_id}/`)
      .then((res) => {
  ...
  async function updatePlenary(plenary_id) {
    loading.value = true;
    await http
      .patch(`plenaries/${plenary_id}/`, plenary.value)
      .then(() => {
