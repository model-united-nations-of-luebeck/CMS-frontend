...
export const useSchoolsStore = defineStore('schools', () => {
    ...
    async function getSchools() {
        loading.value = true
        await http.get("schools/").then( (res) => {
    ...
    async function getSchool(school_id){  //notice the singular form of the function name
        loading.value = true
        await http.get(`schools/${school_id}/`).then( (res) => {
    ...
    async function deleteSchool(school_id){
        await http.delete(`schools/${school_id}/`).then(() => {
